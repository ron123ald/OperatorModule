...
namespace googleMap.Models.Database
{
    ...
    partial void Deletetbl_History(tbl_History instance);
		...
		public Coe25dbDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["Coe25ConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
